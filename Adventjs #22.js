...
function countDecorations(bigTree) {
    ...
    if (bigTree.hasOwnProperty('value')) var deco = bigTree.value
    if (bigTree.left && typeof bigTree.left === 'object') deco += countDecorations(bigTree.left)
    if (bigTree.right && typeof bigTree.right === 'object') deco += countDecorations(bigTree.right)
    return deco
}
